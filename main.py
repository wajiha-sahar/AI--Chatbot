...
openai.api_key = "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"
...
# Define the maximum number of retries and the wait time between retries
MAX_RETRIES = 5
WAIT_TIME = 10  # in seconds

@retry(stop=stop_after_attempt(MAX_RETRIES), wait=wait_fixed(WAIT_TIME))
